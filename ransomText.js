...
if (checkCanPrepareTheRansomNote(newspapersText.trim(), ransomText.trim())) {
  console.log(
    "Yes, we can prepare the ransom note using the given newspaper and ransom message."
  );
} else {
  console.log(
    "No, we can't prepare the ransom note using the given newspaper and ransom message."
  );
}
